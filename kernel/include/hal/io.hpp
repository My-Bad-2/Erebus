#ifndef EREBUS_KERNEL_INCLUDE_HAL_IO_HPP
#define EREBUS_KERNEL_INCLUDE_HAL_IO_HPP
...
namespace kernel::hw {
	...
	public:
		...
		[[gnu::always_inline]] void write(std::size_t offset,
		...
		read(std::size_t offset) const noexcept {
			if (m_type == IoType::PMIO) {
...
#endif // EREBUS_KERNEL_INCLUDE_HAL_IO_HPP
