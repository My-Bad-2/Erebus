...
using LcrSchema =
    klib::BitfieldSchema<klib::Field<"word_length", 0, 2>,
                         klib::Bit<"stop_bits", 2>, klib::Field<"parity", 3, 3>,
                         klib::Bit<"break_enable", 6>, klib::Bit<"dlab", 7>>;

using FcrSchema =
    klib::BitfieldSchema<klib::Bit<"fifo_enable", 0>, klib::Bit<"clear_rx", 1>,
                         klib::Bit<"clear_tx", 2>, klib::Bit<"dma_mode", 3>,
                         klib::Reserved<4>, klib::Bit<"enable_64byte_fifo", 5>,
...
using LsrSchema = klib::BitfieldSchema<
    klib::ReadOnly<"data_ready", 0, 1>, klib::ReadOnly<"overrun_error", 1, 1>,
...
using IerSchema =
    klib::BitfieldSchema<klib::Bit<"rx_available", 0>, klib::Bit<"tx_empty", 1>,
