#ifndef EREBUS_KERNEL_INCLUDE_DRIVERS_ACPI_PARSER_HPP
#define EREBUS_KERNEL_INCLUDE_DRIVERS_ACPI_PARSER_HPP
...
#endif // EREBUS_KERNEL_INCLUDE_DRIVERS_ACPI_PARSER_HPP
