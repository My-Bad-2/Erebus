#ifndef EREBUS_KLIBC_INCLUDE_KFORMAT_UTILS_HPP
#define EREBUS_KLIBC_INCLUDE_KFORMAT_UTILS_HPP

#include <bit>
#include <cstdint>

namespace klibc::detail {
...
#endif // EREBUS_KLIBC_INCLUDE_KFORMAT_UTILS_HPP
