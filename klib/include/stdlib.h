...
void qsort(void* __restrict ptr, size_t count, size_t size,
           int (*comp)(const void*, const void*)) noexcept;

[[gnu::nonnull(1, 2, 5), gnu::pure, gnu::flatten]]
void* bsearch(const void* key, const void* ptr, std::size_t count,
              std::size_t size, int (*comp)(const void*, const void*)) noexcept;
...
[[gnu::const, gnu::flatten]] lldiv_t lldiv(long long numer,
                                           long long denom) noexcept;
[[gnu::const, gnu::flatten]] imaxdiv_t imaxdiv(intmax_t numer,
                                               intmax_t denom) noexcept;
